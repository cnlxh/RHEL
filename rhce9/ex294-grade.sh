...
q13score=0
    ...
    for host in servera serverb serverc serverd workstation;do
        ...
        if [[ -z $BIOS || $BIOS = 1.15.0-1.el9 ]];then
            ...
            fail && echo Q13 "在$host上的/root/hwreport.txt中BIOS为空或没有等于1.15.0-1.el9"
        fi
    done
    for host in servera serverb serverc serverd workstation;do
...
cd /root
scp root@bastion:/home/greg/ansible/inventory /root &> /dev/null
...
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/yum_repo.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/packages.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/selinux.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/apache.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/roles.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/lv.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/hosts.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/issue.yml'
ssh greg@bastion 'cd /home/greg/ansible/ && ansible-navigator run -m stdout /home/greg/ansible/webcontent.yml'
